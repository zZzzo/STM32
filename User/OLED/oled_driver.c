...
#define OLED_RESET_LOW()		GPIO_ResetBits(GPIOC, GPIO_Pin_5)	//低电平复位
#define OLED_RESET_HIGH()		GPIO_SetBits(GPIOC, GPIO_Pin_5)

#define OLED_CMD_MODE()			GPIO_ResetBits(GPIOC, GPIO_Pin_4)		//命令模式
#define OLED_DATA_MODE()		GPIO_SetBits(GPIOC, GPIO_Pin_4)			//数据模式
